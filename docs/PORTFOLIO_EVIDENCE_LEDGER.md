...
| Portfolio architecture | `observable` | One Cloud Run container serves the portfolio and demos through a zero-dependency Node gateway; the portfolio ships no client-side JavaScript. | [Public repository](https://github.com/ryanbaumann/Portfolio) | 2026-07-13 | Validate deployed network behavior when making runtime claims about OAuth, cold starts, quotas, or CI/CD. |
