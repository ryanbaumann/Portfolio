...
- Removed Resume from the primary header, kept it linked from About and the footer, and reduced the mobile header to Field Notes, Work, and About in a single non-scrolling row.
